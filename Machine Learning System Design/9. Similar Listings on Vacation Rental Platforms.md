---
title: "9. Similar Listings on Vacation Rental Platforms"
...
![9-similar-listings-on-vacation-rental-platforms-figure-2](assets/9-similar-listings-on-vacation-rental-platforms/9-similar-listings-on-vacation-rental-platforms-figure-2.png)
...
![9-similar-listings-on-vacation-rental-platforms-figure-3](assets/9-similar-listings-on-vacation-rental-platforms/9-similar-listings-on-vacation-rental-platforms-figure-3.png)
...
To recommend similar listings, we search the embedding space for listings closest to the one currently being viewed. Let's take a look at an example of this. In Figure 9.4, each listing is mapped into a $2 \mathrm{D}$ space. To recommend similar listings to $L_t$, we choose the top 3 listings with the closest embeddings.

![9-similar-listings-on-vacation-rental-platforms-figure-4](assets/9-similar-listings-on-vacation-rental-platforms/9-similar-listings-on-vacation-rental-platforms-figure-4.png)
...
![9-similar-listings-on-vacation-rental-platforms-figure-5](assets/9-similar-listings-on-vacation-rental-platforms/9-similar-listings-on-vacation-rental-platforms-figure-5.png)
...
![9-similar-listings-on-vacation-rental-platforms-figure-6](assets/9-similar-listings-on-vacation-rental-platforms/9-similar-listings-on-vacation-rental-platforms-figure-6.png)
...
![9-similar-listings-on-vacation-rental-platforms-figure-7](assets/9-similar-listings-on-vacation-rental-platforms/9-similar-listings-on-vacation-rental-platforms-figure-7.png)
...
![9-similar-listings-on-vacation-rental-platforms-figure-8](assets/9-similar-listings-on-vacation-rental-platforms/9-similar-listings-on-vacation-rental-platforms-figure-8.png)
...
![9-similar-listings-on-vacation-rental-platforms-figure-9](assets/9-similar-listings-on-vacation-rental-platforms/9-similar-listings-on-vacation-rental-platforms-figure-9.png)
...
![9-similar-listings-on-vacation-rental-platforms-figure-11](assets/9-similar-listings-on-vacation-rental-platforms/9-similar-listings-on-vacation-rental-platforms-figure-11.png)
