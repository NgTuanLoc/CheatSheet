...
![16-proximity-service-figure-1](assets/16-proximity-service/16-proximity-service-figure-1.png)
...
![16-proximity-service-figure-2](assets/16-proximity-service/16-proximity-service-figure-2.png)
...
![16-proximity-service-figure-3](assets/16-proximity-service/16-proximity-service-figure-3.svg)
...
![16-proximity-service-figure-4](assets/16-proximity-service/16-proximity-service-figure-4.png)
...
![16-proximity-service-figure-5](assets/16-proximity-service/16-proximity-service-figure-5.png)
...
![16-proximity-service-figure-6](assets/16-proximity-service/16-proximity-service-figure-6.svg)
...
![16-proximity-service-figure-7](assets/16-proximity-service/16-proximity-service-figure-7.png)
...
![16-proximity-service-figure-8](assets/16-proximity-service/16-proximity-service-figure-8.png)
...
![16-proximity-service-figure-9](assets/16-proximity-service/16-proximity-service-figure-9.png)
...
![16-proximity-service-figure-10](assets/16-proximity-service/16-proximity-service-figure-10.png)
...
![16-proximity-service-figure-11](assets/16-proximity-service/16-proximity-service-figure-11.png)
...
![16-proximity-service-figure-12](assets/16-proximity-service/16-proximity-service-figure-12.png)
...
![16-proximity-service-figure-13](assets/16-proximity-service/16-proximity-service-figure-13.png)
...
![16-proximity-service-figure-14](assets/16-proximity-service/16-proximity-service-figure-14.png)
...
![16-proximity-service-figure-15](assets/16-proximity-service/16-proximity-service-figure-15.svg)
...
![16-proximity-service-figure-16](assets/16-proximity-service/16-proximity-service-figure-16.png)
...
![16-proximity-service-figure-17](assets/16-proximity-service/16-proximity-service-figure-17.png)
...
- S2 is great for geofencing because it can cover arbitrary areas with varying levels (Figure 17). According to Wikipedia, “A geofence is a virtual perimeter for a real-world geographic area. A geo-fence could be dynamically generated—as in a radius around a point location, or a geo-fence can be a predefined set of boundaries (such as school zones or neighborhood boundaries)” \[25\].
	![16-proximity-service-figure-18](assets/16-proximity-service/16-proximity-service-figure-18.png)
	Figure 17 Geofence
...
- Updating the index is easy. For example, to remove a business from the index, we just need to remove it from the corresponding row with the same *geohash* and *business\_id*. See Figure 18 for a concrete example.
	![16-proximity-service-figure-19](assets/16-proximity-service/16-proximity-service-figure-19.png)
...
![16-proximity-service-figure-20](assets/16-proximity-service/16-proximity-service-figure-20.svg)
...
![16-proximity-service-figure-21](assets/16-proximity-service/16-proximity-service-figure-21.png)
...
![16-proximity-service-figure-22](assets/16-proximity-service/16-proximity-service-figure-22.png)
...
- Privacy laws. Some countries may require user data to be used and stored locally. In this case, we could set up a region in that country and employ DNS routing to restrict all requests from the country to only that region.
	![16-proximity-service-figure-23](assets/16-proximity-service/16-proximity-service-figure-23.png)
...
![16-proximity-service-figure-24](assets/16-proximity-service/16-proximity-service-figure-24.png)
...
![16-proximity-service-figure-25](assets/16-proximity-service/16-proximity-service-figure-25.png)
