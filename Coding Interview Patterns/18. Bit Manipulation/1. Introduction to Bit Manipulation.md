...
source: "https://bytebytego.com/courses/coding-patterns/bit-manipulation/introduction-to-bit-manipulation"
author:
published:
created: 2026-04-24
...
![1-introduction-to-bit-manipulation-figure-1](../assets/18.%20Bit%20Manipulation/1-introduction-to-bit-manipulation/1-introduction-to-bit-manipulation-figure-1.svg)
...
![1-introduction-to-bit-manipulation-figure-2](../assets/18.%20Bit%20Manipulation/1-introduction-to-bit-manipulation/1-introduction-to-bit-manipulation-figure-2.svg)
...
![1-introduction-to-bit-manipulation-figure-3](../assets/18.%20Bit%20Manipulation/1-introduction-to-bit-manipulation/1-introduction-to-bit-manipulation-figure-3.svg)
...
- **Left shift (`<< n`)**: Shifts the bits of a number to the left by `n` positions, adding 0s on the right. This is equivalent to multiplying a number by `2n`.
	![1-introduction-to-bit-manipulation-figure-4](../assets/18.%20Bit%20Manipulation/1-introduction-to-bit-manipulation/1-introduction-to-bit-manipulation-figure-4.svg)
...
- **Right shift (`>> n`)**: Shifts the bits of a number to the right by `n` positions, discarding bits on the right. This is equivalent to dividing a number by `2n` (integer division).
	![1-introduction-to-bit-manipulation-figure-5](../assets/18.%20Bit%20Manipulation/1-introduction-to-bit-manipulation/1-introduction-to-bit-manipulation-figure-5.svg)
...
![1-introduction-to-bit-manipulation-figure-6](../assets/18.%20Bit%20Manipulation/1-introduction-to-bit-manipulation/1-introduction-to-bit-manipulation-figure-6.svg)
