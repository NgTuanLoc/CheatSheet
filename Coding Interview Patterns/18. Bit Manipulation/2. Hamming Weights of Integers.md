---
title: "2. Hamming Weights of Integers"
source: "https://bytebytego.com/courses/coding-patterns/bit-manipulation/hamming-weights-of-integers"
author:
published:
created: 2026-04-24
...
![2-hamming-weights-of-integers-figure-1](../assets/18.%20Bit%20Manipulation/2-hamming-weights-of-integers/2-hamming-weights-of-integers-figure-1.svg)
...
![2-hamming-weights-of-integers-figure-2](../assets/18.%20Bit%20Manipulation/2-hamming-weights-of-integers/2-hamming-weights-of-integers-figure-2.svg)
...
![2-hamming-weights-of-integers-figure-3](../assets/18.%20Bit%20Manipulation/2-hamming-weights-of-integers/2-hamming-weights-of-integers-figure-3.svg)
...
- If the LSB of `x` is 0, there is no difference in the number of bits between `x` and `x >> 1`:
	![2-hamming-weights-of-integers-figure-4](../assets/18.%20Bit%20Manipulation/2-hamming-weights-of-integers/2-hamming-weights-of-integers-figure-4.svg)
...
- If the LSB of `x` is 1, the difference in the number of bits between `x` and `x >> 1` is 1:
	![2-hamming-weights-of-integers-figure-5](../assets/18.%20Bit%20Manipulation/2-hamming-weights-of-integers/2-hamming-weights-of-integers-figure-5.svg)
