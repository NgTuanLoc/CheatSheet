...
![2-pair-sum-sorted-figure-1](../assets/1.%20Two%20Pointers/2-pair-sum-sorted/2-pair-sum-sorted-figure-1.svg)
...
![2-pair-sum-sorted-figure-2](../assets/1.%20Two%20Pointers/2-pair-sum-sorted/2-pair-sum-sorted-figure-2.svg)
...
![2-pair-sum-sorted-figure-3](../assets/1.%20Two%20Pointers/2-pair-sum-sorted/2-pair-sum-sorted-figure-3.svg)
...
![2-pair-sum-sorted-figure-4](../assets/1.%20Two%20Pointers/2-pair-sum-sorted/2-pair-sum-sorted-figure-4.svg)
...
![2-pair-sum-sorted-figure-5](../assets/1.%20Two%20Pointers/2-pair-sum-sorted/2-pair-sum-sorted-figure-5.svg)
...
**Time complexity:** The time complexity of pair\_sum\_sorted is $O(n)$ because we perform approximately $n$ iterations using the two-pointer technique in the worst case.
