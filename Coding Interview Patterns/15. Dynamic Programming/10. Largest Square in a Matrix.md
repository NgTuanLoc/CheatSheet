---
title: "10. Largest Square in a Matrix"
source: "https://bytebytego.com/courses/coding-patterns/dynamic-programming/largest-square-in-a-matrix"
author:
published:
created: 2026-04-24
...
![10-largest-square-in-a-matrix-figure-1](../assets/15.%20Dynamic%20Programming/10-largest-square-in-a-matrix/10-largest-square-in-a-matrix-figure-1.svg)
...
![10-largest-square-in-a-matrix-figure-2](../assets/15.%20Dynamic%20Programming/10-largest-square-in-a-matrix/10-largest-square-in-a-matrix-figure-2.svg)
...
![10-largest-square-in-a-matrix-figure-3](../assets/15.%20Dynamic%20Programming/10-largest-square-in-a-matrix/10-largest-square-in-a-matrix-figure-3.svg)
...
![10-largest-square-in-a-matrix-figure-4](../assets/15.%20Dynamic%20Programming/10-largest-square-in-a-matrix/10-largest-square-in-a-matrix-figure-4.svg)
...
![10-largest-square-in-a-matrix-figure-5](../assets/15.%20Dynamic%20Programming/10-largest-square-in-a-matrix/10-largest-square-in-a-matrix-figure-5.svg)
...
![10-largest-square-in-a-matrix-figure-6](../assets/15.%20Dynamic%20Programming/10-largest-square-in-a-matrix/10-largest-square-in-a-matrix-figure-6.svg)
...
![10-largest-square-in-a-matrix-figure-7](../assets/15.%20Dynamic%20Programming/10-largest-square-in-a-matrix/10-largest-square-in-a-matrix-figure-7.svg)
...
**Time complexity:** The time complexity of `largest_square_in_a_matrix` is $O(m\cdot n)$ because each cell of the DP table is populated once.
...
![10-largest-square-in-a-matrix-figure-8](../assets/15.%20Dynamic%20Programming/10-largest-square-in-a-matrix/10-largest-square-in-a-matrix-figure-8.svg)

Image represents a 5x5 matrix illustrating a coding pattern, possibly related to dynamic programming or a similar algorithm. The matrix is labeled with row and column indices (0-4) along its top and left side. The matrix cells contain numerical values (0, 1, 2). The bottom two rows are shaded light gray, labeled 'prev\_row: 3' and 'curr\_row: 4,' respectively. Gray arrows indicate data flow: elements from 'prev\_row: 3' (1, 2, 2, 0, 1) are used to calculate the elements in 'curr\_row: 4' (starting with 1), with each arrow pointing from a 'prev\_row' element to its corresponding influence on a 'curr\_row' element. A text annotation to the right explains that to compute 'curr\_row: 4,' only 'prev\_row: 3' is needed, highlighting a dependency relationship between rows in the matrix, suggesting an iterative or recursive calculation process.
