---
title: "3. Minimum Coin Combination"
source: "https://bytebytego.com/courses/coding-patterns/dynamic-programming/minimum-coin-combination"
author:
published:
created: 2026-04-24
...
![3-minimum-coin-combination-figure-1](../assets/15.%20Dynamic%20Programming/3-minimum-coin-combination/3-minimum-coin-combination-figure-1.svg)
...
![3-minimum-coin-combination-figure-2](../assets/15.%20Dynamic%20Programming/3-minimum-coin-combination/3-minimum-coin-combination-figure-2.svg)
...
![3-minimum-coin-combination-figure-3](../assets/15.%20Dynamic%20Programming/3-minimum-coin-combination/3-minimum-coin-combination-figure-3.svg)
...
![3-minimum-coin-combination-figure-4](../assets/15.%20Dynamic%20Programming/3-minimum-coin-combination/3-minimum-coin-combination-figure-4.svg)
...
![3-minimum-coin-combination-figure-5](../assets/15.%20Dynamic%20Programming/3-minimum-coin-combination/3-minimum-coin-combination-figure-5.svg)
...
- With memoization, each subproblem is solved only once. Since there are at most $target$ subproblems, and we iterate through all $n$ coins for each subproblem, the time complexity is $O(target\cdot n)$.
