---
title: "9. 0/1 Knapsack"
source: "https://bytebytego.com/courses/coding-patterns/dynamic-programming/01-knapsack"
author:
published:
created: 2026-04-24
...
![9-01-knapsack-figure-1](../assets/15.%20Dynamic%20Programming/9-01-knapsack/9-01-knapsack-figure-1.svg)
...
The brute force approach involves making this decision for every item. Since two choices can be made for each item, this results in $2\cdot 2\cdot 2…2=2n$ possible combinations of choices. As we can see, generating all possible combinations is inefficient.
...
![9-01-knapsack-figure-2](../assets/15.%20Dynamic%20Programming/9-01-knapsack/9-01-knapsack-figure-2.svg)
...
![9-01-knapsack-figure-3](../assets/15.%20Dynamic%20Programming/9-01-knapsack/9-01-knapsack-figure-3.svg)
...
![9-01-knapsack-figure-4](../assets/15.%20Dynamic%20Programming/9-01-knapsack/9-01-knapsack-figure-4.svg)
...
![9-01-knapsack-figure-5](../assets/15.%20Dynamic%20Programming/9-01-knapsack/9-01-knapsack-figure-5.svg)
...
![9-01-knapsack-figure-6](../assets/15.%20Dynamic%20Programming/9-01-knapsack/9-01-knapsack-figure-6.svg)
...
![9-01-knapsack-figure-7](../assets/15.%20Dynamic%20Programming/9-01-knapsack/9-01-knapsack-figure-7.svg)
...
![9-01-knapsack-figure-8](../assets/15.%20Dynamic%20Programming/9-01-knapsack/9-01-knapsack-figure-8.svg)
...
![9-01-knapsack-figure-9](../assets/15.%20Dynamic%20Programming/9-01-knapsack/9-01-knapsack-figure-9.svg)
...
**Time complexity:** The time complexity of `knapsack` is $O(n\cdot cap)$ because each cell of the DP table is populated once.

**Space complexity:** The space complexity is $O(n\cdot cap)$ because we're maintaining a DP table that stores $(n+1)\cdot (cap+1)$ elements.
