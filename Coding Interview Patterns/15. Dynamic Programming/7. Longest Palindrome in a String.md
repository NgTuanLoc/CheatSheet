---
title: "7. Longest Palindrome in a String"
source: "https://bytebytego.com/courses/coding-patterns/dynamic-programming/longest-palindrome-in-a-string"
author:
published:
created: 2026-04-24
...
![7-longest-palindrome-in-a-string-figure-1](../assets/15.%20Dynamic%20Programming/7-longest-palindrome-in-a-string/7-longest-palindrome-in-a-string-figure-1.svg)
...
![7-longest-palindrome-in-a-string-figure-2](../assets/15.%20Dynamic%20Programming/7-longest-palindrome-in-a-string/7-longest-palindrome-in-a-string-figure-2.svg)
...
- Base case: All substrings of length 1 are palindromes. So, set `dp[i][i]` to true for all values of `i`.
	![7-longest-palindrome-in-a-string-figure-3](../assets/15.%20Dynamic%20Programming/7-longest-palindrome-in-a-string/7-longest-palindrome-in-a-string-figure-3.svg)
...
- Base case: Substrings of length 2 are palindromes if both its characters are the same. So, set `dp[i][i + 1]` to true if `s[i] == s[i + 1]`.
	![7-longest-palindrome-in-a-string-figure-4](../assets/15.%20Dynamic%20Programming/7-longest-palindrome-in-a-string/7-longest-palindrome-in-a-string-figure-4.svg)
...
**Time complexity:** The time complexity of `longest_palindrome_in_a_string` is $O(n^2)$ because each cell of the $n\cdot n$ DP table is populated once.
...
![7-longest-palindrome-in-a-string-figure-5](../assets/15.%20Dynamic%20Programming/7-longest-palindrome-in-a-string/7-longest-palindrome-in-a-string-figure-5.svg)
...
![7-longest-palindrome-in-a-string-figure-6](../assets/15.%20Dynamic%20Programming/7-longest-palindrome-in-a-string/7-longest-palindrome-in-a-string-figure-6.svg)
