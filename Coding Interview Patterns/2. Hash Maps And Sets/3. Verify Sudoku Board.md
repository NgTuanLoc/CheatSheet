---
title: "3. Verify Sudoku Board"
source: "https://bytebytego.com/courses/coding-patterns/hash-maps-and-sets/verify-sudoku-board"
author:
published:
created: 2026-04-23
...
![3-verify-sudoku-board-figure-1](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-1.svg)
...
![3-verify-sudoku-board-figure-2](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-2.svg)
...
![3-verify-sudoku-board-figure-3](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-3.svg)
...
![3-verify-sudoku-board-figure-4](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-4.svg)
...
![3-verify-sudoku-board-figure-5](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-5.svg)
...
![3-verify-sudoku-board-figure-6](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-6.svg)
...
![3-verify-sudoku-board-figure-7](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-7.svg)
...
![3-verify-sudoku-board-figure-8](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-8.svg)
...
![3-verify-sudoku-board-figure-9](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-9.svg)

Image represents two Python variable assignments. The first line assigns a list named \`row\_sets\` to a list containing multiple empty \`hashset()\` objects. The indices 0, 1, and 8 are shown under the corresponding \`hashset()\` calls, indicating the positions of these sets within the list. The ellipsis (...) signifies that there are additional \`hashset()\` objects between index 1 and 8. The second line similarly assigns a list named \`col\_sets\` to another list of empty \`hashset()\` objects, again with indices 0, 1, and 8 shown, and an ellipsis indicating additional \`hashset()\` objects between index 1 and 8. Both \`row\_sets\` and \`col\_sets\` appear to represent collections of sets, likely used to store data organized in a row-column structure, possibly for a matrix or grid-like data representation. The use of \`hashset()\` suggests that the data within each set is unordered and contains only unique elements.
...
![3-verify-sudoku-board-figure-10](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-10.svg)
...
![3-verify-sudoku-board-figure-11](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-11.svg)
...
![3-verify-sudoku-board-figure-12](../assets/2.%20Hash%20Maps%20And%20Sets/3-verify-sudoku-board/3-verify-sudoku-board-figure-12.svg)
