---
title: "12. Kth Smallest Number in a Binary Search Tree"
source: "https://bytebytego.com/courses/coding-patterns/trees/kth-smallest-number-in-a-binary-search-tree"
author:
published:
created: 2026-04-23
...
![12-kth-smallest-number-in-a-binary-search-tree-figure-1](../assets/11.%20Trees/12-kth-smallest-number-in-a-binary-search-tree/12-kth-smallest-number-in-a-binary-search-tree-figure-1.svg)
...
![12-kth-smallest-number-in-a-binary-search-tree-figure-2](../assets/11.%20Trees/12-kth-smallest-number-in-a-binary-search-tree/12-kth-smallest-number-in-a-binary-search-tree-figure-2.svg)
...
![12-kth-smallest-number-in-a-binary-search-tree-figure-3](../assets/11.%20Trees/12-kth-smallest-number-in-a-binary-search-tree/12-kth-smallest-number-in-a-binary-search-tree-figure-3.svg)
...
- The reason we push nodes onto the stack as we go is so they can be processed later.
	...
	while node:
	    ...
	    node = node.left
	```
1. Once we can no longer move left, we pop the node off the top of the stack. Let's call it the **current node**. Initially, this node will represent the smallest node. After this, the current node will subsequently represent the next smallest node, and so on until we reach the kth smallest node.
