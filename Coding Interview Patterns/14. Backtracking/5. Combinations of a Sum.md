---
title: "5. Combinations of a Sum"
source: "https://bytebytego.com/courses/coding-patterns/backtracking/combinations-of-a-sum"
author:
published:
created: 2026-04-24
...
![5-combinations-of-a-sum-figure-1](../assets/14.%20Backtracking/5-combinations-of-a-sum/5-combinations-of-a-sum-figure-1.svg)
...
![5-combinations-of-a-sum-figure-2](../assets/14.%20Backtracking/5-combinations-of-a-sum/5-combinations-of-a-sum-figure-2.svg)
...
![5-combinations-of-a-sum-figure-3](../assets/14.%20Backtracking/5-combinations-of-a-sum/5-combinations-of-a-sum-figure-3.svg)
...
![5-combinations-of-a-sum-figure-4](../assets/14.%20Backtracking/5-combinations-of-a-sum/5-combinations-of-a-sum-figure-4.svg)

Image represents a tree-like structure illustrating a recursive algorithm, possibly for finding subsets of an array \`nums = \[1, 2, 3\]\` that sum to 4. The root node is \`\[\], start\_index = 0\`, representing an empty subset and a starting index of 0. From the root, three branches extend, each representing a subset starting with one of the elements from \`nums\`. Each node shows the current subset (e.g., \`\[1\]\`, \`\[2\]\`, \`\[3\]\`) and its \`start\_index\`. These nodes further branch, recursively adding subsequent elements from \`nums\` (starting from the \`start\_index\`). The leaf nodes display the final subsets (e.g., \`\[1, 1\]\`, \`\[1, 2\]\`, \`\[1, 3\]\`, etc.). Each leaf node is labeled with the sum of its elements; those summing to 4 are marked in green (\`sum == 4\`), while those exceeding 4 are marked in red (\`sum > 4\`). The arrows indicate the flow of the algorithm, showing how subsets are built recursively. The gray arrows represent paths that are not explored further because they exceed the target sum.
...
![5-combinations-of-a-sum-figure-5](../assets/14.%20Backtracking/5-combinations-of-a-sum/5-combinations-of-a-sum-figure-5.svg)
...
![5-combinations-of-a-sum-figure-6](../assets/14.%20Backtracking/5-combinations-of-a-sum/5-combinations-of-a-sum-figure-6.svg)
