---
title: "3. Find All Subsets"
source: "https://bytebytego.com/courses/coding-patterns/backtracking/find-all-subsets"
author:
published:
created: 2026-04-24
...
![3-find-all-subsets-figure-1](../assets/14.%20Backtracking/3-find-all-subsets/3-find-all-subsets-figure-1.svg)
...
![3-find-all-subsets-figure-2](../assets/14.%20Backtracking/3-find-all-subsets/3-find-all-subsets-figure-2.svg)
...
![3-find-all-subsets-figure-3](../assets/14.%20Backtracking/3-find-all-subsets/3-find-all-subsets-figure-3.svg)
...
![3-find-all-subsets-figure-4](../assets/14.%20Backtracking/3-find-all-subsets/3-find-all-subsets-figure-4.svg)
...
**Time complexity:** The time complexity of `find_all_subsets` is $O(n^2\cdot n)$. This is because the state space tree has a depth of $n$ and a branching factor of 2 since there are two decisions we make at each state. For each of the $2n$ subsets created, we make a copy of them and add the copy to the output, which takes $O(n)$ time. This results in a total time complexity of $O(n^2\cdot n)$.
