---
title: "4. N Queens"
source: "https://bytebytego.com/courses/coding-patterns/backtracking/n-queens"
author:
published:
created: 2026-04-24
...
![4-n-queens-figure-1](../assets/14.%20Backtracking/4-n-queens/4-n-queens-figure-1.svg)
...
![4-n-queens-figure-2](../assets/14.%20Backtracking/4-n-queens/4-n-queens-figure-2.svg)
...
![4-n-queens-figure-3](../assets/14.%20Backtracking/4-n-queens/4-n-queens-figure-3.svg)
...
![4-n-queens-figure-4](../assets/14.%20Backtracking/4-n-queens/4-n-queens-figure-4.svg)
...
![4-n-queens-figure-5](../assets/14.%20Backtracking/4-n-queens/4-n-queens-figure-5.svg)
...
**Time complexity:** The time complexity of n\_queens is $O(n!)$. Here’s why:
...
- This process continues for subsequent queens, resulting in a total of $n\cdot (n-a)\cdot (n-b)…1$ choices. Even though this doesn’t exactly equate to $n!$ ($n\cdot (n-1)\cdot (n-2)…1$ ), this trend approximately results in a factorial growth of the search space.
