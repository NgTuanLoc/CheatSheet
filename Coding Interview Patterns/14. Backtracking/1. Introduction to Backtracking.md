...
source: "https://bytebytego.com/courses/coding-patterns/backtracking/introduction-to-backtracking"
author:
published:
created: 2026-04-24
...
![1-introduction-to-backtracking-figure-1](../assets/14.%20Backtracking/1-introduction-to-backtracking/1-introduction-to-backtracking-figure-1.svg)
...
![1-introduction-to-backtracking-figure-2](../assets/14.%20Backtracking/1-introduction-to-backtracking/1-introduction-to-backtracking-figure-2.svg)
...
![1-introduction-to-backtracking-figure-3](../assets/14.%20Backtracking/1-introduction-to-backtracking/1-introduction-to-backtracking-figure-3.svg)
...
![1-introduction-to-backtracking-figure-4](../assets/14.%20Backtracking/1-introduction-to-backtracking/1-introduction-to-backtracking-figure-4.svg)
...
![1-introduction-to-backtracking-figure-5](../assets/14.%20Backtracking/1-introduction-to-backtracking/1-introduction-to-backtracking-figure-5.svg)
...
![1-introduction-to-backtracking-figure-6](../assets/14.%20Backtracking/1-introduction-to-backtracking/1-introduction-to-backtracking-figure-6.svg)
...
The time complexity is often estimated as $O(b\cdot d)$, where $b$ denotes the branching factor and $d$ denotes the depth. This is because in the worst case, every node at each level of the tree needs to be explored during a typical backtracking algorithm.
...
![1-introduction-to-backtracking-figure-7](../assets/14.%20Backtracking/1-introduction-to-backtracking/1-introduction-to-backtracking-figure-7.svg)
