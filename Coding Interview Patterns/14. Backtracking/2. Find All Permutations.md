---
title: "2. Find All Permutations"
source: "https://bytebytego.com/courses/coding-patterns/backtracking/find-all-permutations"
author:
published:
created: 2026-04-24
...
![2-find-all-permutations-figure-1](../assets/14.%20Backtracking/2-find-all-permutations/2-find-all-permutations-figure-1.svg)
...
![2-find-all-permutations-figure-2](../assets/14.%20Backtracking/2-find-all-permutations/2-find-all-permutations-figure-2.svg)
...
![2-find-all-permutations-figure-3](../assets/14.%20Backtracking/2-find-all-permutations/2-find-all-permutations-figure-3.svg)
...
![2-find-all-permutations-figure-4](../assets/14.%20Backtracking/2-find-all-permutations/2-find-all-permutations-figure-4.svg)
...
![2-find-all-permutations-figure-5](../assets/14.%20Backtracking/2-find-all-permutations/2-find-all-permutations-figure-5.svg)
...
![2-find-all-permutations-figure-6](../assets/14.%20Backtracking/2-find-all-permutations/2-find-all-permutations-figure-6.svg)
...
- For each of these $n$ candidates, we explore $n - 1$ more candidates, then $n - 2$ more candidates, etc, until we have explored all permutations. This results in a total of $n\cdot (n-1)\cdot (n-2)…1=n!$ permutations.
