---
title: "4. Maximum Collinear Points"
source: "https://bytebytego.com/courses/coding-patterns/math-and-geometry/maximum-collinear-points"
author:
published:
created: 2026-04-24
...
![4-maximum-collinear-points-figure-1](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-1.svg)
...
![4-maximum-collinear-points-figure-2](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-2.svg)
...
![4-maximum-collinear-points-figure-3](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-3.svg)
...
![4-maximum-collinear-points-figure-4](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-4.svg)

Image represents a Cartesian coordinate system with x and y axes ranging from 0 to 4. Two lines are plotted: an orange line with a positive slope passing through points (1,1), (2,2), and (3,3), and a cyan line with a negative slope intersecting the orange line at (2,2) and passing through points (1,3) and (3,1). Numerical values representing the slopes (1 and -1) are labeled along each line. A downward-pointing arrow labeled 'focal\_point' indicates the intersection point (2,2) of the two lines. To the right, a table labeled 'slope\_map' is shown, containing two columns: 'slope' and 'freq'. The 'slope' column lists the slopes 1 and -1, while the 'freq' column shows their corresponding frequencies, 3 and 2 respectively. This suggests the diagram illustrates a concept where lines with different slopes are analyzed, with the intersection point highlighted as a focal point, and the frequency of each slope recorded in the table.

This allows us to find the maximum number of points collinear with this focal point:

![4-maximum-collinear-points-figure-5](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-5.svg)

Image represents a Cartesian coordinate system with a line passing through several points. The x-axis and y-axis are labeled 'x' and 'y' respectively, ranging from 0 to 4. A gray line connects points (1,1), (2,2), and (4,4), with the value '1' indicated as the vertical and horizontal distance between consecutive points. A larger, lighter-shaded area highlights this line segment. The point (2,2) is specifically labeled 'focal\_point' with a downward-pointing arrow indicating its significance. Several other black dots are plotted at coordinates (1.5, 3), (3,1), and are not directly connected to the main line. Separately, a table labeled 'slope\_map' is shown, containing two columns titled 'slope' and 'freq'. The 'slope' column lists values '1' and '-1', while the 'freq' column lists '3' and '2', suggesting a frequency count associated with each slope. The overall image likely illustrates a concept related to line fitting, slope analysis, or data distribution within a coding pattern context.
...
![4-maximum-collinear-points-figure-6](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-6.svg)
...
![4-maximum-collinear-points-figure-7](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-7.svg)
...
![4-maximum-collinear-points-figure-8](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-8.svg)
...
![4-maximum-collinear-points-figure-9](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-9.svg)
...
![4-maximum-collinear-points-figure-10](../assets/19.%20Math%20and%20Geometry/4-maximum-collinear-points/4-maximum-collinear-points-figure-10.svg)
