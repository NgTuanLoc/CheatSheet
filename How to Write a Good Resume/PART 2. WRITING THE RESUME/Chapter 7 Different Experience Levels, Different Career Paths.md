...
![chapter-7-different-experience-levels-different-career-paths-figure-3](../assets/PART%202.%20WRITING%20THE%20RESUME/chapter-7-different-experience-levels-different-career-paths/chapter-7-different-experience-levels-different-career-paths-figure-3.png)
...
![chapter-7-different-experience-levels-different-career-paths-figure-4](../assets/PART%202.%20WRITING%20THE%20RESUME/chapter-7-different-experience-levels-different-career-paths/chapter-7-different-experience-levels-different-career-paths-figure-4.png)

Image represents a section of a tech resume detailing employment history. The image is divided into two distinct sections. The top section, labeled 'On a break,' indicates a period of leave from March 2020 to August 2020. A bullet point precedes an explanation for the break: 'Due to COVID-19, I decided to take a break to spend more time with my family.' Below this, a second section, labeled 'Previous Position,' shows a time period of employment from January 2019 to March 2020. A bullet point follows, indicating that further details about this previous position would be provided below (represented by an ellipsis '...'). The sections are arranged vertically, with the break information appearing above the previous position information, chronologically representing the candidate's work history. No URLs or parameters are present.

![chapter-7-different-experience-levels-different-career-paths-figure-5](../assets/PART%202.%20WRITING%20THE%20RESUME/chapter-7-different-experience-levels-different-career-paths/chapter-7-different-experience-levels-different-career-paths-figure-5.png)

Image represents a section of a tech resume, structured vertically with two distinct blocks. The top block, labeled 'Travelling & writing,' details a period from January 2020 to the present. A bullet point precedes a description explaining a professional break taken to travel to Asia and write a novel. Below this, a second block, labeled 'Previous Position,' covers the period from 2016 to January 2020. A bullet point indicates that further details about this previous position would follow, although they are not shown in the image. The two blocks are separated by a significant vertical space, and each block includes a date range indicating the timeframe of the described activity or position. No URLs or parameters are visible.
...
![chapter-7-different-experience-levels-different-career-paths-figure-7](../assets/PART%202.%20WRITING%20THE%20RESUME/chapter-7-different-experience-levels-different-career-paths/chapter-7-different-experience-levels-different-career-paths-figure-7.png)
