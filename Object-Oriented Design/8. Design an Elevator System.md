---
title: "8. Design an Elevator System"
...
![8-design-an-elevator-system-figure-1](assets/8-design-an-elevator-system/8-design-an-elevator-system-figure-1.svg)
...
![8-design-an-elevator-system-figure-2](assets/8-design-an-elevator-system/8-design-an-elevator-system-figure-2.svg)
...
![8-design-an-elevator-system-figure-5](assets/8-design-an-elevator-system/8-design-an-elevator-system-figure-5.svg)
...
![8-design-an-elevator-system-figure-6](assets/8-design-an-elevator-system/8-design-an-elevator-system-figure-6.svg)
...
*Note*: To learn more about the Strategy Pattern and its common use cases, refer to the **[Parking Lot](https://bytebytego.com/courses/object-oriented-design-interview/design-a-parking-lot)** chapter of the book.
...
![8-design-an-elevator-system-figure-7](assets/8-design-an-elevator-system/8-design-an-elevator-system-figure-7.svg)

Image represents a UML class diagram depicting the \`ElevatorDispatch\` class. The diagram shows the class name \`ElevatorDispatch\` preceded by the class symbol 'C' within a rectangular box. Inside the box, a private member variable \`DispatchingStrategy strategy\` is declared, indicating that the \`ElevatorDispatch\` class has a member variable of type \`DispatchingStrategy\`. Below this, a public method \`dispatchElevatorCar\` is defined. This method takes three parameters: an integer \`floor\`, a \`Direction\` object \`direction\`, and a \`List \` named \`elevators\`. The method's purpose is to dispatch an elevator car, taking into account the requested floor, direction of travel, and a list of available elevator cars. The overall structure suggests a design pattern where the dispatching logic can be altered by changing the \`DispatchingStrategy\` object.
...
![8-design-an-elevator-system-figure-8](assets/8-design-an-elevator-system/8-design-an-elevator-system-figure-8.svg)

Image represents a UML diagram depicting an interface named \`DispatchingStrategy\`. The interface is defined by a single method, \`selectElevator\`, which takes three parameters: a \`List \` named \`elevators\`, an integer \`floor\`, and a \`Direction\` object named \`direction\`. The method's return type is \`ElevatorCar\`. The \`I\` in a circle preceding the interface name indicates that it's an interface, implying that classes implementing this interface must provide a concrete implementation for the \`selectElevator\` method. The method signature suggests that the purpose of the interface is to define a strategy for selecting an appropriate elevator car from a list of available cars based on the requested floor and direction of travel.
...
![8-design-an-elevator-system-figure-9](assets/8-design-an-elevator-system/8-design-an-elevator-system-figure-9.svg)
...
*Note*: To learn more about the Observer Pattern and its common use cases, refer to the **[Further Reading](https://bytebytego.com/courses/object-oriented-design-interview/design-an-elevator-system#further-reading-observer-design-pattern)** section at the end of this chapter.
...
![8-design-an-elevator-system-figure-10](assets/8-design-an-elevator-system/8-design-an-elevator-system-figure-10.svg)
