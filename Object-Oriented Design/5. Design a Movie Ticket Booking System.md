---
title: "5. Design a Movie Ticket Booking System"
...
![5-design-a-movie-ticket-booking-system-figure-1](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-1.svg)
...
![5-design-a-movie-ticket-booking-system-figure-2](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-2.svg)
...
![5-design-a-movie-ticket-booking-system-figure-3](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-3.svg)
...
*Note*: To learn more about the Strategy pattern and its everyday use cases, refer to the **[Parking Lot](https://bytebytego.com/courses/object-oriented-design-interview/design-a-parking-lot)** chapter of the book.
...
![5-design-a-movie-ticket-booking-system-figure-4](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-4.svg)
...
![5-design-a-movie-ticket-booking-system-figure-5](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-5.svg)
...
![5-design-a-movie-ticket-booking-system-figure-6](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-6.svg)
...
![5-design-a-movie-ticket-booking-system-figure-7](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-7.svg)
...
![5-design-a-movie-ticket-booking-system-figure-8](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-8.svg)

Image represents a class diagram for a \`Order\` class in an object-oriented programming context. The diagram is a rectangular box with the class name 'Order' and a 'C' symbol indicating it's a class, prominently displayed at the top. Below this, the class's attributes are listed, preceded by a minus sign (–): a \`List \` named \`tickets\` representing a list of Ticket objects, and a \`LocalDateTime\` object named \`orderDate\` representing the order's date and time. Further down, the class's methods are shown, preceded by a plus sign (+): a constructor \`Order(LocalDateTime orderDate)\` that takes a \`LocalDateTime\` object as input, a \`void addTicket(Ticket ticket)\` method to add a \`Ticket\` object to the \`tickets\` list, a \`BigDecimal calculateTotalPrice()\` method that returns the total price of the order as a \`BigDecimal\`, and a \`List getAllTickets()\` method that returns the list of \`Ticket\` objects associated with the order. No connections to other classes are shown, implying this is a partial view of a larger class diagram.
...
![5-design-a-movie-ticket-booking-system-figure-9](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-9.svg)
...
![5-design-a-movie-ticket-booking-system-figure-10](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-10.svg)
...
![5-design-a-movie-ticket-booking-system-figure-11](assets/5-design-a-movie-ticket-booking-system/5-design-a-movie-ticket-booking-system-figure-11.svg)
